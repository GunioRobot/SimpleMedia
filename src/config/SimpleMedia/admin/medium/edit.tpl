...
{form enctype='multipart/form-data' cssClass='z-form'}
    ...
    <fieldset>
        ...
        <div class="z-formrow">
            ...
            {formtextinput group='medium' id='title' mandatory=true readOnly=false __title='Input the title of the medium' textMode='singleline' maxLength=255 cssClass='required'}
...
{/if}
        ...
        <div class="z-formrow">
            ...
            {formtextinput group='medium' id='description' mandatory=false __title='Input the description of the medium' textMode='multiline' rows='6' cols='50' cssClass=''}
        </div>
    </fieldset>
...
<![endif]-->
{pageaddvar name='javascript' value='modules/SimpleMedia/javascript/SimpleMedia_uploads.js'}

  
    <div id="uploadmodern" class="z-hide">
        <p>Nur eine Datei, alle Dateitypen:</p>
        <input type="file" id="file1" name="file1" />
        <div id="file1dropzone" class="simplemediaDropZone">
            {gt text='Drop files from your desktop here'}
        </div>
        <output id="file_list_s" class="simplemediaUploadPreviewThumbs"></output>
        <div id="myprogressbar1" class="simplemediaProgressBar"><div id="myprogress1" class="simplemediaProgress">0%</div></div>

        <p>Mehrere Dateien, nur Bilder:</p>
        <input type="file" id="files2" name="files2[]" multiple />
        <div id="file2dropzone" class="simplemediaDropZone">
            {gt text='Drop images from your desktop here'}
        </div>
        <output id="file_list_m" class="simplemediaUploadPreviewThumbs"></output>
        <div id="myprogressbar2" class="simplemediaProgressBar"><div id="myprogress2" class="simplemediaProgress">0%</div></div>
    </div>
...
/* <![CDATA[ */
    document.observe('dom:loaded', function() {
        var fhOptions1 = {
            ...
            typeFilter: '',
            inputId: 'file1',
            outputId: 'file_list_s',
            dropZoneId: 'file1dropzone',
            progressBarId: 'myprogressbar1',
            progressId: 'myprogress1'
        }
        var example1handler = new simmedFileHandler(fhOptions1);

        var fhOptions2 = {
            multiple: true,
            typeFilter: 'image',
            inputId: 'files2',
            outputId: 'file_list_m',
            dropZoneId: 'file2dropzone',
            progressBarId: 'myprogressbar2',
            progressId: 'myprogress2'
        }
        var example2handler = new simmedFileHandler(fhOptions2);
    });
/* ]]> */
</script>
...
/* <![CDATA[ */
    ...
    document.observe('dom:loaded', function() {
        ...
        if (simmedBrowserKnowsFileApi() === true) {
            $('uploadmodern').removeClassName('z-hide');
        }
