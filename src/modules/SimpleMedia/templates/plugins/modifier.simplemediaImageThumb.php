 ...
 */
function smarty_modifier_simplemediaImageThumb($fileName = '', $filePath = '', $width = 100, $height = 80, $thumbArgs = array())
{
    /**
     ...
     */
    return SimpleMedia_Util_Image::getThumb($filePath, $width, $height, $thumbArgs);
}
