...
<table class="z-datatable">
    ...
    <tr>
        <th id="htitle" scope="col" class="z-left">
            {sortlink __linktext='Title' sort='title' currentsort=$sort sortdir=$sdir all=$all modname='SimpleMedia' type='user' func='view' ot='medium'}
        </th>
        <th id="hthefile" scope="col" class="z-left">
            {sortlink __linktext='The file' sort='theFile' currentsort=$sort sortdir=$sdir all=$all modname='SimpleMedia' type='user' func='view' ot='medium'}
        </th>
        <th id="hdescription" scope="col" class="z-left">
            {sortlink __linktext='Description' sort='description' currentsort=$sort sortdir=$sdir all=$all modname='SimpleMedia' type='user' func='view' ot='medium'}
        </th>
