...
class SimpleMedia_Api_Base_Selection extends Zikula_AbstractApi
{
    ...
    protected function determineObjectType($args, $methodName = '')
    {
        ...
        if (!in_array($objectType, SimpleMedia_Util_Controller::getObjectTypes('api', $utilArgs))) {
            $objectType = SimpleMedia_Util_Controller::getDefaultObjectType('api', $utilArgs);
        }
        return $objectType;
    }
