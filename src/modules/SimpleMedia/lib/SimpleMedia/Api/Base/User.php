...
class SimpleMedia_Api_Base_User extends Zikula_AbstractApi
{
    ...
    public function encodeurl($args)
    {
        ...
        $allowedObjectTypes = SimpleMedia_Util_Controller::getObjectTypes('api', $utilArgs);
        $objectType = ((isset($args['args']['ot']) && in_array($args['args']['ot'], $allowedObjectTypes)) ? $args['args']['ot'] : SimpleMedia_Util_Controller::getDefaultObjectType('api', $utilArgs));
