...
class SimpleMedia_Util_Base_View extends Zikula_AbstractBase
{
    ...
    public static function availableExtensions($type, $objectType, $func, $args = array())
    {
        $extParams = array();
        if ($func == 'view') {
            if (SecurityUtil::checkPermission('SimpleMedia::', '::', ACCESS_ADMIN)) {
    ...
    protected static function processPdf(Zikula_View $view, $template)
    {
        ...
        $fileTitle = SimpleMedia_Util_Controller::formatPermalink(System::getVar('sitename'))
                   . '-'
                   . SimpleMedia_Util_Controller::formatPermalink(PageUtil::getVar('title'))
                   . '-' . date('Ymd') . '.pdf';
