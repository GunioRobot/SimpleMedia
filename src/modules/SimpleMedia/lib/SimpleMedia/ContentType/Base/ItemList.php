...
class SimpleMedia_ContentType_Base_ItemList extends Content_AbstractContentType
{
    ...
    public function getTitle()
    {
        ...
        return __('SimpleMedia items', $dom);
    }

    public function getDescription()
    {
        $dom = ZLanguage::getModuleDomain('SimpleMedia');
        return __('Display SimpleMedia items.', $dom);
    }

    public function loadData(&$data)
    {
        if (!isset($data['objectType']) || !in_array($data['objectType'], SimpleMedia_Util_Controller::getObjectTypes('contentType'))) {
            $data['objectType'] = SimpleMedia_Util_Controller::getDefaultObjectType('contentType');
        }
